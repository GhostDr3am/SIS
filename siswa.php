  ...
  <div class="col-md-12">
    ...
    <form class="mb-3" action="index.php" method="post">
      <div class="form-row">
        ...
        <!-- tombol tambah data -->
        <div class="col-2">
          <a class="btn btn-info" href="?page=siswaTambah" role="button"><i class="fas fa-plus"></i> Tambah</a>
        </div>
      </div>
    </form>
        ...
        while ($data = mysqli_fetch_assoc($query)) { ?>
          <tr>
            ...
            <td width="120" class="center">
              <a title="Ubah" class="btn btn-outline-info" href="?page=siswaUbah&nis=<?= $data['nis']; ?>"><i class="fas fa-edit"></i></a>
              <a title="Hapus" class="btn btn-outline-danger" href="siswa_proses_hapus.php?nis=<?= $data['nis']; ?>" onclick="return confirm('Anda yakin ingin menghapus siswa <?= $data['nama']; ?>?');"><i class="fas fa-trash"></i></a>
            </td>
          </tr>
        <?php
          $no++;
